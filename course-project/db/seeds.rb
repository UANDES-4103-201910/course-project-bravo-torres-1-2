...
{name: 'User', lastname: 'Pissed',email: "user@pissed.com",password: 'password123',address: 'san carlos 2200',phone: '954240055', profile: 'admin profile', is_suspended: 'false',has_prev_suspension: 'false',is_blocked: 'false', geofence_id: 1,last_time: DateTime.strptime("06/10/2019 17:00", "%m/%d/%Y %H:%M"),useris:'Regular'}])
